#!/bin/bash
# ARM64 Ubuntu installation script for LiteLLM MCP server
# This script bypasses MCP package installation issues on ARM64
...
echo -e "${BLUE}🚀 ARM64 Ubuntu LiteLLM MCP Server Installation${NC}"
echo "=================================================="
...
# Install core dependencies manually (bypassing MCP package)
...
# Install MCP dependencies manually
print_status "Installing MCP dependencies manually..."
...
# Create minimal MCP server implementation
...
echo ""
echo -e "${GREEN}🎉 ARM64 installation complete!${NC}"
echo "=================================="
echo ""
...
echo ""
print_status "ARM64 installation completed successfully!" 